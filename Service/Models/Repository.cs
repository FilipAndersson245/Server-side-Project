        ...
        public Repository()
        {
            bookList = new List<Book>
            {
                new Book {
                    ...
                    BookGenre = new Genre { Name = "Fantasy"  } },
                new Book {
                    ISBN = "978-0007488322",
                ...
                new Book {
                    ...
                    BookGenre = new Genre { Name = "Textbook"  } },
                new Book {
                    ISBN = "978-0007527502",
                    ...
                    BookGenre = new Genre { Name = "Thriller"  } },
                new Book {
                    ISBN = "978-0552161275",
                ...
                new Book {
                    ...
                    BookGenre = new Genre { Name = "Romance"  } },
                new Book {
                    ISBN = "978-0345391803",
                    ...
                    BookGenre = new Genre { Name = "Science Fiction"  } },
                new Book {
                    ISBN = "978-0753555637",
                    ...
                    BookGenre = new Genre { Name = "Biography"  } },
                new Book {
                    ISBN = "978-9383656950",
                ...
                new Book {
                    ...
                    BookGenre = new Genre { Name = "Classic Fiction"  } },
                new Book {
                    ISBN = "978-0099908401",
